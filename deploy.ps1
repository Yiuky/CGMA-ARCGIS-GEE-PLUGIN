...
Copy-Item "arcgis_addin\Install\*" $cacheDir -Force
Get-ChildItem -Path $cacheDir -Filter "*.pyc" | Remove-Item -Force -ErrorAction SilentlyContinue
Stop-Process -Name pythonw -Force -ErrorAction SilentlyContinue

$found = Get-Content "$cacheDir\gee_gui.py" | Select-String "v1.2"
...
Write-Output "DEPLOY_COMPLETE_V12"
